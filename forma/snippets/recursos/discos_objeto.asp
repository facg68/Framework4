                    ...
                    <td style="width:65%;">
                        <div class="line-group">
                            <div class="line">
                                ...
                                <input class="no-field" style="width: 75px;" type="text" id="AEdicion" name="AEdicion" value="<%= tt("AEdicion") %>" placeholder="9999" required>
                            </div>

                            <div class="line">
                                <label class="label tiny2">Título</label>
                                <input class="no-field" style="width: 400px;" 
                            ...
                            <% if tt("Editor") = "PE" then %>
                                <div class="line">
                                    <label class="label tiny2">Original</label>
                                    <input class="no-field" style="width: 400px;" 
                            ...
                            <% if tt("Editor") <> "HW" then %>
                                <div class="line">
                                    ...
                                    <label class="label tiny2"><%= ida_label %></label>

                                    <input class="no-field" style="width: 400px;" type="text" id="InDirAu" name="InDirAu" 
                            ...
                            <div class="line">
                                <label class="label tiny2" >Forma</label>
                            ...
                            <% if tt("Editor") = "DM" OR tt("Editor") = "VM" then %>
                                <div class="line">
                                    ...
                                    <select class="no-field normal" name="Recuento" id="Recuento" required >
                            ...
                            <div class="line label-top">
                                ...
                                <textarea class="no-field description" 
                            ...
                            <% if tt("Editor") = "PE" or tt("Editor") = "VM" or tt("Editor") = "LI" then %>
                                <div class="line">
                                    ...
                                    <input class="no-field tiny" type="text" name="DuraPag" id="DuraPag" value="<%= tt("DuraPag") %>">
                                </div>
                            <% end if %>
                            ...
                            <% 
                                ...
                                %>
                                <div class="line">
                                    <label class="label tiny2">Es 3D</label>

                                    <select class="no-field tiny" name="Es3D" id="Es3D" required >
                            ...
                            <% if tt("Editor") <> "HW" then %>
                                <div class="line">
                                    <label class="label tiny2">Digital</label>
...
<script>
    function discos_objeto_init() {
        redimWindow("discos_objeto", <%= Snip_Width %>)
    }    
</script> 