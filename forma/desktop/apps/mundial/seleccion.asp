  ...
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/>
		...
		<style type="text/css">
			...
			div#CopaCampeon img:hover, td img#Fase5Bandera1:hover {
				cursor: default;
			}
			...
			.estadio {
				height: 0;
				padding: 0;
				background-image: url(Imagenes/estadio3.jpg);
	...
	<body onload="CambiarGrupo('A');">
		<%
			dim con, sqlString, t, categoria, sw, secuencia, apendice, Grupo
			dim Codigo, Nombre, Posicion, indice, gr
			
			'
			' Codigo ASP que previene seguir creando Pollas
			'
			' Se verifica el ESTATUS en la TABLA "Estatus" en el Server.
			' Si el Campo "Estatus" tiene un valor de "1", se puede
			' seguir creando pollas. Al cambiar ese valor a cualquier
			' otro valor, se cierra la pagina y se devuelve al usuario
			' a la pagina principal
			'
		
			set con = server.CreateObject("ADODB.Connection")
			con.open Application("Conn")
			set t = con.execute("SELECT Estatus FROM dbo.mundial_Estatus WHERE Codigo='Polla';")
		
			if t.eof or t.bof then
			...
			'
			' Fin de Verificacion de Cierre...
			'
		%>	
		
		<table width="95%" align="center" cellpadding="0" cellspacing="0">
			<tr>
				<td><img src="Imagenes/header.jpg" border="0" style="width:100%" /></td>
			</tr>
		</table>
		
		<div id="Preliminares" align="center" style="display:block;">
			<table width="95%" height="40px;" border="0" align="center" cellspacing="0">  
				<tr>
					<td width="25%" onclick="toggleGrupos(1)" cellspacing="0" style="background-color:#000000; color:#FFFFFF; font-size:14px;">
						<label id="toggleOcultarGrupos">Ocultar Grupo</label>
					</td>
					
					<td width="50%" cellspacing="0" style="background-color:#000000; color:#FFFFFF; font-size:16px;">
						<%
							gr = "ABCDEFGH"
					...
					<td width="25%" cellspacing="0" style="background-color:#000000; color:#FFFFFF; font-size:16px;">&nbsp;</td>					
				</tr>
			</table>

			<table width="95%" cellpadding="15" cellspacing="0">
				<tr style="background-color:rgb(247, 247, 247); width:100%;">
					<td style="padding: 10px; text-align:center; font-size:14px;">
						Seleccione dos equipos de cada uno de los 8 grupos. Haga clic (o pulse) sobre los cuadros al lado de las banderas de los equipos para seleccionar 
						cual de ellos terminar&aacute; la primera ronda en la primera y la segunda posici&oacute;n. En el momento en que los equipos sean seleccionados, 
						las banderas ir&aacute;n apareciendo en la im&aacute;gen del estadio en la parte inferior de la p&aacute;gina.
						<br /><br />
						Puede cambiar las posiciones hasta que tenga a la alineaci&oacute;n que le parezca la combinaci&oacute;n ganadora!
					</td>
				</tr>
				...
				<tr style="display:none;">
					<td>
						...
						<img id="grpImagen" src="imagenes/banderas/bandera_def.png" border="0" />
					</td>
				</tr>

				<tr style="width:100%; background-color: rgb(224, 224, 224);">
					<td style="padding: 0px; text-align:center;">
						<table style="width:100%; border:">
							<tr>
								<td style="text-align:center; vertical-align:middle; background-color:#1A497F; width:10%">
									<a href="#" onclick="Rotar(1)">
										<img src="imagenes/grupos/grp_anterior.png"  border="0" />
									</a>			
								</td>
								...
								<td style="width:76%;">
									<table style="width:100%;">
										<tr>
											<td styke="width:25%; text-align:center;">
												<img id="BanderaPos1" src="imagenes/banderas/bandera_def.png" border="0" />
												<br />
											...
											<td style="text-align:center; width:25%;">
												<img id="BanderaPos3" src="imagenes/banderas/bandera_def.png" border="0" />
												<br />
										...
										<tr>
											<td colspan="5" style="background-color:rgb(199, 199, 199);">
												&nbsp;<br/>
											</td>
										</tr>
										...
										<tr>
											<td style="text-align:center; width: 25%;">
												<img id="BanderaPos2" src="imagenes/banderas/bandera_def.png" border="0" />
												<br />
											...
											<td style="text-align:center; width:25%;">
												<img id="BanderaPos4" src="imagenes/banderas/bandera_def.png" border="0" />
												<br />
								...
								<td style="text-align:center; vertical-align:middle; background-color:#1A497F; width:12%">
									<a href="#" onclick="Rotar(2)">
										<img src="imagenes/grupos/grp_siguiente.png"  border="0"/>
									</a>			
								</td>
							</td>
						</table>
				...
				<tr style="background-color:rgb(247, 247, 247); width:100%;">
					<td style="padding: 10px; text-align:center; font-size:14px;">
						Al finalizar su selecci&oacute;n, haga clic (o pulse) sobre las banderas en el estadio en la parte inferior de la p&aacute;gina para ir 
						definiendo los resultados de los partidos que ha seleccionado. Complete el cuadro hasta llegar al equipo ganador del Mundial.
						<br /><br />
						Usted puede cambiar los equipos seleccionando nuevas banderas desde los grupos, o cambiar los resultados de cada partido con s&oacute;lo hacer clic (o 
						pulsar) las banderas que ya se encuentran en el estadio.
					</td>
				</tr>
			</table>
		</div>
		...
		<div id="Seleccionados" align="center">
			<table width="95%" border="0" cellpadding="8" cellspacing="0" style="background-color:#E0E0E0;">
				<tr>
					<td width="25%" onclick="toggleGrupos(0)" style="background-color:#000000; color:#FFFFFF; font-size:16px;">
						<label id="toggleVerGrupos"></label>
					</td>
				
					<td width="50%" style="background-color:#000000; color:#FFFFFF; font-size:16px;">
						EQUIPOS SELECCIONADOS
					</td>
					
					<td width="25%" style="background-color:#000000; color:#FFFFFF; font-size:16px;">
						<input id="btnGrabar" type="button" value="Grabar Apuesta" style="display:none;" onclick="PasarSubmit();" />
					</td>					
				</tr>			
	  	  	</table>		
		
			<table width="95%" border="0" cellspacing="0"style="background-color:#E2E2E2;">
				<tr>
					<td width="5%">&nbsp;</td>
					<td width="2%">&nbsp;</td>
					<td width="5%">&nbsp;</td>
				...
				<tr>
					...
					<td>
						<img id="BanderaGrpA1" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" />
					...
					<td >
						<img id="BanderaGrpB1" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" />
					...
					<td>
						<img id="BanderaGrpC1" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" />
					...
					<td >
						<img id="BanderaGrpD1" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" />
					...
					<td >
						<img id="BanderaGrpE1" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" />
					...
					<td>
						<img id="BanderaGrpF1" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" />
					...
					<td >
						<img id="BanderaGrpG1" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" />
					...
					<td >
						<img id="BanderaGrpH1" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" />
				...
				<tr>
					<td>&nbsp;</td>
					<td>
						<img id="BanderaGrpA2" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" />
						<br /><label id="NombreGrpA2"></label>
					</td>

					<td>&nbsp;</td>
					<td>
						<img id="BanderaGrpB2" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" />
						<br /><label id="NombreGrpB2"></label>
					</td>
					
					<td>&nbsp;</td>					
					<td>
						<img id="BanderaGrpC2" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" />
						<br /><label id="NombreGrpC2"></label>
					</td>

					<td>&nbsp;</td>
					<td>
						<img id="BanderaGrpD2" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" />
						<br /><label id="NombreGrpD2"></label>
					</td>

					<td>&nbsp;</td>					
					<td>
						<img id="BanderaGrpE2" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" />
						<br /><label id="NombreGrpE2"></label>
					</td>

					<td>&nbsp;</td>					
					<td>
						<img id="BanderaGrpF2" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" />
						<br /><label id="NombreGrpF2"></label>
					</td>
					
					<td>&nbsp;</td>					
					<td>
						<img id="BanderaGrpG2" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" />
						<br /><label id="NombreGrpG2"></label>
					</td>
					
					<td>&nbsp;</td>					
					<td>
						<img id="BanderaGrpH2" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" />
		...
		<div id="Mapa" align="center">
			<table width="95%" class="estadio">
				...
				<tr>
					<td  height="80">
						<img id="Fase1Bandera1" src="imagenes/banderas/bandera_def.png" border="0"  width="50px" height="34px" onclick="Promover(1,1,2,1)" />
					...
					<td rowspan="2">
						<img id="Fase2Bandera1" src="imagenes/banderas/bandera_def.png" border="0"  width="50px" height="34px" onclick="Promover(2,1,3,1)" />
					...
					<td rowspan="2">
						<img id="Fase2Bandera5" src="imagenes/banderas/bandera_def.png" border="0"  width="50px" height="34px"  onclick="Promover(2,5,3,3)"  />
						<br /><label id="Fase2Nombre5" style="color:#FFFFFF; background-color:#000;"></label>
					</td>
					
					<td><img id="Fase1Bandera9" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" onclick="Promover(1,9,2,5)"  /><br />
				...
				<tr>
					<td height="80">
						<img id="Fase1Bandera2" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" onclick="Promover(1,2,2,1)" />
						<br /><label id="Fase1Nombre2" style="color:#FFFFFF; background-color:#000;"></label>
					</td>
					
					<td rowspan="2">
						<img id="Fase3Bandera1" src="imagenes/banderas/bandera_def.png" border="0"  width="50px" height="34px"  onclick="Promover(3,1,4,1)" />
					...
					<td rowspan="2">
						<img id="Fase3Bandera3" src="imagenes/banderas/bandera_def.png" border="0"  width="50px" height="34px"  onclick="Promover(3,3,4,2)" />
						<br /><label id="Fase3Nombre3" style="color:#FFFFFF; background-color:#000;"></label>					</td>
					
					<td>
						<img id="Fase1Bandera10" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" onclick="Promover(1,10,2,5)" />
						<br /><label id="Fase1Nombre10" style="color:#FFFFFF; background-color:#000;"></label>					</td>
				</tr>

				<tr>
					<td height="80">
						<img id="Fase1Bandera3" src="imagenes/banderas/bandera_def.png" border="0"  width="50px" height="34px" onclick="Promover(1,3,2,2)" />
						<br /><label id="Fase1Nombre3" style="color:#FFFFFF; background-color:#000;"></label>					</td>
					
					<td rowspan="2">
						<img id="Fase2Bandera2" src="imagenes/banderas/bandera_def.png" border="0"  width="50px" height="34px"  onclick="Promover(2,2,3,1)" />
					...
					<td rowspan="2">
						<img id="Fase2Bandera6" src="imagenes/banderas/bandera_def.png" border="0"  width="50px" height="34px"  onclick="Promover(2,6,3,3)"  />
						<br /><label id="Fase2Nombre6" style="color:#FFFFFF; background-color:#000;"></label>					</td>
					
					<td>
						<img id="Fase1Bandera11" src="imagenes/banderas/bandera_def.png" border="0"  width="50px" height="34px" onclick="Promover(1,11,2,6)" />
						<br /><label id="Fase1Nombre11" style="color:#FFFFFF; background-color:#000;"></label>					</td>
				</tr>

				<tr>
					<td height="80">
						<img id="Fase1Bandera4" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" onclick="Promover(1,4,2,2)" />
						<br /><label id="Fase1Nombre4" style="color:#FFFFFF; background-color:#000;"></label>					</td>
					<td>&nbsp;</td>
					
					<td rowspan="2">
						<img id="Fase4Bandera1" src="imagenes/banderas/bandera_def.png" border="0"  width="50px" height="34px"  onclick="Promover(4,1,5,1)" />
						<br /><label id="Fase4Nombre1" style="color:#FFFFFF; background-color:#000;"></label>					</td>
					
					<td>&nbsp;</td>
					
					<td rowspan="2">
						<img id="Fase4Bandera2" src="imagenes/banderas/bandera_def.png" border="0"  width="50px" height="34px"  onclick="Promover(4,2,5,1)" />
						<br /><label id="Fase4Nombre2" style="color:#FFFFFF; background-color:#000;"></label>					</td>
					
					<td>&nbsp;</td>
					<td>
						<img id="Fase1Bandera12" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" onclick="Promover(1,12,2,6)" />
						<br /><label id="Fase1Nombre12" style="color:#FFFFFF; background-color:#000;"></label>					</td>
				</tr>

				<tr>
					<td height="80">
						<img id="Fase1Bandera5" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" onclick="Promover(1,5,2,3)" />
						<br /><label id="Fase1Nombre5" style="color:#FFFFFF; background-color:#000;"></label>					</td>
					
					<td rowspan="2">
						<img id="Fase2Bandera3" src="imagenes/banderas/bandera_def.png" border="0"  width="50px" height="34px"  onclick="Promover(2,3,3,2)"  />
					...
					<td rowspan="2">
						<img id="Fase2Bandera7" src="imagenes/banderas/bandera_def.png" border="0"  width="50px" height="34px"  onclick="Promover(2,7,3,4)" />
						<br /><label id="Fase2Nombre7" style="color:#FFFFFF; background-color:#000;"></label>					</td>
					
					<td>
						<img id="Fase1Bandera13" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" onclick="Promover(1,13,2,7)" />
						<br /><label id="Fase1Nombre13" style="color:#FFFFFF; background-color:#000;"></label>					</td>
				</tr>

				<tr>
					<td height="80">
						<img id="Fase1Bandera6" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" onclick="Promover(1,6,2,3)"  />
						<br /><label id="Fase1Nombre6" style="color:#FFFFFF; background-color:#000;"></label>					</td>
					
					<td rowspan="2">
						<img id="Fase3Bandera2" src="imagenes/banderas/bandera_def.png" border="0"  width="50px" height="34px"  onclick="Promover(3,2,4,1)" />
					...
					<td colspan="3" rowspan="3">
						<div id="ExplicacionFinal" style="text-align:center; display:none; font-weight:bold;  font-family:Arial, Helvetica, sans-serif; font-size:16px;color:#000;">					
							Revise su apuesta cuidadosamente.<br /><br />
							Aun puede modificar sus elecciones haciendo click en las banderas 
							del cuadro o cambiar los equipos en la seleccion de grupos.<br /><br />
							Cuando este listo, presione "Grabar Apuesta" en 
							la barra de Equipos Seleccionados						</div>					</td>
					
					<td rowspan="2">
						<img id="Fase3Bandera4" src="imagenes/banderas/bandera_def.png" border="0"  width="50px" height="34px"  onclick="Promover(3,4,4,2)" />
						<br /><label id="Fase3Nombre4" style="color:#FFFFFF; background-color:#000;"></label>					</td>
					
					<td>
						<img id="Fase1Bandera14" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" onclick="Promover(1,14,2,7)" />
						<br /><label id="Fase1Nombre14" style="color:#FFFFFF; background-color:#000;"></label>					</td>
				</tr>

				<tr>
					<td height="80">
						<img id="Fase1Bandera7" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" onclick="Promover(1,7,2,4)"  />
						<br /><label id="Fase1Nombre7" style="color:#FFFFFF; background-color:#000;"></label>					</td>
					
					<td rowspan="2">
						<img id="Fase2Bandera4" src="imagenes/banderas/bandera_def.png" border="0"  width="50px" height="34px"  onclick="Promover(2,4,3,2)" />
						<br /><label id="Fase2Nombre4" style="color:#FFFFFF; background-color:#000;"></label>					</td>
					
					<td rowspan="2">
						<img id="Fase2Bandera8" src="imagenes/banderas/bandera_def.png" border="0"  width="50px" height="34px" onclick="Promover(2,8,3,4)" />
						<br /><label id="Fase2Nombre8" style="color:#FFFFFF; background-color:#000;"></label>					</td>
					
					<td>
						<img id="Fase1Bandera15" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" onclick="Promover(1,15,2,8)" />
						<br /><label id="Fase1Nombre15" style="color:#FFFFFF; background-color:#000;"></label>					</td>
				</tr>

				<tr>
					<td height="80">
						<img id="Fase1Bandera8" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px" onclick="Promover(1,8,2,4)" />
						<br /><label id="Fase1Nombre8" style="color:#FFFFFF; background-color:#000;"></label>				  </td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>
						<img id="Fase1Bandera16" src="imagenes/banderas/bandera_def.png" border="0" width="50px" height="34px"  onclick="Promover(1,16,2,8)" />
		...
		<div id="Apuesta" style="display:none;">
			<!--
				Aqui se crea un FORM que sera el que se lleve los datos al siguiente 
				formulario ASP. Solo tiene 31 campos INPUT para pasar la apuesta a
				la pagina que graba los datos...
				
				Estos campos se llenan mediante JavaScrip para ser procesados
				mediante ASP en la siguiente pagina...
			-->
			<form name="FormularioDatos" id="FormularioDatos" action="datos.asp" method="post">
				<%
					for k = 1 to 31
		...
		<script type="text/javascript">
			...
			function Promover(a,b,c,d) {
				//
				// Aqui empiezan a ponerse las cosas divertidas...
				//
				// Cada vez que el usuario hace un click sobre una de las banderas,
				// esta "bandera" (en realidad, el nombre del equipo en el label)
				// pasa al objeto destino (y se llama la funcion de auto-reemplazo
				// global, para actualizar donde aparece este equipo en los 
				// distintos niveles del cuadro)
				//
			...
			function toggleGrupos(opcion) {
				if (opcion == 1) {
					document.getElementById("Preliminares").style.display="none";
					document.getElementById("toggleVerGrupos").innerHTML="VER GRUPOS";					
				}
				else {
					document.getElementById("Preliminares").style.display="block";				
					document.getElementById("toggleVerGrupos").innerHTML="";
				}
			}
