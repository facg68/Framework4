			...
			<tr>
				<td>
					<table width="100%" style="margin-left: auto; margin-right: auto; padding: 0px; border-spacing; 0px;">
						<tr>
							<td width="95%" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 18px; text-align: center middle; color:rgb(255, 255, 255);">
								<%
									if Tiquete <> "" then
										response.write UCase(Nombre) & " / <span style='color:#FFFF00;'> CODIGO UNICO: " & Tiquete & "</span>"
									...
									<tr>
										<td>
											<div style="height:660px; overflow:auto;">
												<table style="width: 100%; border-style: none; padding: 0px: border-spacing: 0px;">
													<%
														sqlString = "Exec dbo.mundial_TablaPuntos;"
															...
															do
																...
																<tr class="fondo<%= indicefondo %>">
																	<td width="80%" style="text-align:left; padding: 10px; font-size: 12px;">
																		<span onclick="VerPolla('<%= t("Secuencia") %>')">
																			<%= Ucase(t("Nombre")) %>
																		</span>
																	</td>
																	
																	<td width="10%" style="text-align:center; padding: 10px; font-size: 12px;">
																		<a href="#" onclick="VerPolla('<%= t("Secuencia") %>')">
																			<%= t("PuntajeTotal") %>
																		</a>
																	</td>
