...
<html>
    <head>
        ...
        <%
            ...
            dim pCon, ptt, pProc, sqlString, Rol, ordenadoPor
                                ...
                                <%
                                    ...
                                    if not (ptt.bof or ptt.eof) then
                                        response.write "<table style='width: 100%; border: none; border-spacing: 0px;'>"
                                            ...
                                            response.write "<tr>"
                                                response.write "<td class = 'tabDetalles' colspan='" & cuantosSistemas & "' " 
                                                ...
                                                do
                                                    sqlString = "SELECT p.proSistema, p.proCodigo, p.proNombre AS NomProceso, " & _
                                                        ...
                                                        "LEFT OUTER JOIN (SELECT detRol, detRolSistema, detRolProceso " & _
                                                                ...
                                                                "WHERE (p.proMenuItem = 1) AND (p.proSistema = '" & ptt("sysCodigo") & "') " & _
                                                                "ORDER BY NomProceso;"

                                                    response.write "<div id = '" & ptt("sysCodigo") & "' style='display: none; text-align: left; font-size: 16px; line-height:1.8em;'>"
                                                            ...
                                                            do
                                                                ...
                                                                %>
                                                                    <input type='checkbox' id='<%= pProc_id %>' name='<%= pProc_id %>' value='1' 
                                                                        <% if pProc("Selected") = 1 then response.write "checked" %>>&nbsp;&nbsp;<%= pProc("NomProceso") %>
                                                                <%
                                                                response.write "<br/>"
                                                                pProc.movenext
