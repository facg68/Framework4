...
<html>
    ...
    <body>
        <%
            ...
            Notas = limpiar(Request.Form("txtAreaNotas"))
            ...
            ver = Request.Form("param_ver")
            tipo = Request.Form("param_tipo")
            categ = Request.Form("param_categ")
            orden1 = Request.Form("param_orden1")
            orden2 = Request.Form("param_orden2")
