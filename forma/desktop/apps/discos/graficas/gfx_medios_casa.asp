...
<html>
    <head>
        ...
        <title>Medios Por Casa</title>
        <!-- #include virtual = "/core/includes/kernel/head.inc" -->  

        <%
            thisSystem = "discos"
            thisProcess = "discos.0320"
            SysLockOut
            ...
            if Amo = "" then 
                CargarDefaults Usuario, "mCasa"
            else
                ActualizarDefaults Usuario, "mCasa", Tipo, Amo
            end if
    ...
    <body plantilla="grafica" reserva="165">
        ...
        <form id="formulario" name="formulario" method="post" action="gfx_medios_casa.asp">
            ...
            <div class="main">
                <%
                    sqlString = "exec discos_gfx_casa '" & Usuario & "', " & Tipo & ", " & Amo       
