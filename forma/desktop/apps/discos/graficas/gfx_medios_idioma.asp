...
<html>
    <head>
        ...
        <title>Música Por Idioma</title>
        <!-- #include virtual = "/core/includes/kernel/head.inc" -->  

        <%
            thisSystem = "discos"
            thisProcess = "discos.0350"
            SysLockOut
            ...
            if Amo = "" then 
                CargarDefaults Usuario, "mIdioma"
            else
                ActualizarDefaults Usuario, "mIdioma", Tipo, Amo
            end if
    ...
    <body plantilla="grafica" reserva="165">
        ...
        <form id="formulario" name="formulario" method="post" action="gfx_medios_idioma.asp">
            ...
            <div class="main">
                <%
                    sqlString = "exec discos_gfx_idioma '" & Usuario & "', " & Tipo & ", " & Amo       
                    apexColumns "", "chart", sqlString, "Nombre", "Cuantos", "#064f8aff", 125     
                %>            
            </div>
        </form>
