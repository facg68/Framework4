...
<html>
    <head>
        ...
        <title>Medios Por Tienda</title>
        <!-- #include virtual = "/core/includes/kernel/head.inc" -->  

        <%
            thisSystem = "discos"
            thisProcess = "discos.0330"
            SysLockOut
            ...
            if Amo = "" then 
                CargarDefaults Usuario, "mTienda"
            else
                ActualizarDefaults Usuario, "mTienda", Tipo, Amo
            end if
    ...
    <body plantilla="grafica" reserva="165">
        ...
        <form id="formulario" name="formulario" method="post" action="gfx_medios_tienda.asp">
            ...
            <div class="main">
                <%
                    sqlString = "exec discos_gfx_tienda '" & Usuario & "', " & Tipo & ", " & Amo       
